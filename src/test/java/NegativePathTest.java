...
public class NegativePathTest {
    ...
    @Test
    void wrongName() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Alec Koff");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79421234567");
    ...
    void wrongPhoneNumber() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("89421234567");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
